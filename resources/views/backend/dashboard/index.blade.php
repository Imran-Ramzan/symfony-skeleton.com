...
<h3>Symfony Skeleton API</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item">Symfony Skeleton API</li>
@endsection
...
<div class="container-fluid">
  <div class="row second-chart-list third-news-update">
    ...
    <div class="col-sm-6 col-xl-4 col-lg-12">
        <div class="card o-hidden static-top-widget-card">
          <div class="card-body">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">Authors</h6>
              ...
              <div class="card-body pt-0">
                <div class="appointment-table table-responsive">
                  <table class="table table-bordernone">
                    <tbody>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle mb-3" src="{{ asset('backend/images/appointment/app-ent.jpg') }}" alt="Image description">
                      ...
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('backend/images/appointment/app-ent.jpg') }}" alt="Image description">
                          <div class="status-circle bg-primary"></div>
                        </td>
